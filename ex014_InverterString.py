...
nome = input("Qual o nome que será manipulado?").upper()

nome_invertido = nome.split()

print(' '.join(reversed(nome_invertido)))

nome_contrario = reversed(nome)

print(''.join(nome_contrario))
